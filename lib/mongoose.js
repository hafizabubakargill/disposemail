...
if (!MONGODB_URI) {
  if (process.env.NODE_ENV === 'production') {
    throw new Error('CRITICAL: MONGODB_URI environment variable is missing in production!');
  }
  console.warn('⚠️ MONGODB_URI missing, falling back to localhost for development');
}
