...
export default function ApiDocs() {
    return (
        <main className="min-h-screen bg-background text-foreground p-8 md:p-24 relative overflow-hidden transition-colors">
            ...
            <div className="max-w-4xl mx-auto z-10 relative">
                <h1 className="text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-500">
                    API Documentation
                </h1>
                <p className="text-gray-600 dark:text-gray-400 mb-12">Programmatic access to DisposeMail services.</p>

                <div className="space-y-12">
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-200 mb-4">1. Get Emails</h2>
                        <div className="bg-white dark:bg-[#111] border border-gray-200 dark:border-[#222] rounded-xl overflow-hidden shadow-sm">
                            <div className="bg-gray-100 dark:bg-[#161616] p-4 border-b border-gray-200 dark:border-[#222] font-mono text-sm flex gap-4">
                            ...
                            <div className="p-6">
                                ...
                                <ul className="text-gray-600 dark:text-gray-300 font-mono text-sm mb-6">
                                    <li><span className="text-blue-600 dark:text-blue-400">address</span> (required): The email address to fetch messages for.</li>
                                </ul>
                                    ...
                                    {`[
  {
    ...
    "received_at": 1769460979808
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-200 mb-4">2. Webhooks</h2>
                        <p className="text-gray-600 dark:text-gray-400 mb-4">You can configure Cloudflare Workers to forward emails to our ingestion endpoint.</p>
                        <div className="bg-white dark:bg-[#111] border border-gray-200 dark:border-[#222] rounded-xl overflow-hidden shadow-sm">
                            <div className="bg-gray-100 dark:bg-[#161616] p-4 border-b border-gray-200 dark:border-[#222] font-mono text-sm flex gap-4">
                                <span className="text-blue-600 dark:text-blue-400 font-bold">POST</span>
                                <span className="text-gray-800 dark:text-gray-200">https://disposemail.xyz/api/webhook/email</span>
                            </div>
