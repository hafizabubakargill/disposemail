    ...
    return (
        <main className="min-h-screen bg-[#050505] text-white p-8 md:p-24 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto z-10 relative">
                <h1 className="text-4xl font-bold mb-12 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">
                    Frequently Asked Questions
                </h1>

                <div className="space-y-8">
                    <div className="bg-[#111] border border-[#222] p-6 rounded-2xl">
                        <h3 className="text-xl font-semibold mb-3 text-gray-200">How long do emails last?</h3>
                    ...
                    <div className="bg-[#111] border border-[#222] p-6 rounded-2xl">
                        <h3 className="text-xl font-semibold mb-3 text-gray-200">Is it really private?</h3>
                        <p className="text-gray-400 leading-relaxed">
                    ...
                    <div className="bg-[#111] border border-[#222] p-6 rounded-2xl">
                        <h3 className="text-xl font-semibold mb-3 text-gray-200">Can I send emails?</h3>
                        <p className="text-gray-400 leading-relaxed">
                    ...
                    <div className="bg-[#111] border border-[#222] p-6 rounded-2xl">
                        <h3 className="text-xl font-semibold mb-3 text-gray-200">Why does the address change?</h3>
                        <p className="text-gray-400 leading-relaxed">
