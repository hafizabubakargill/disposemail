    ...
    return (
        <main className="min-h-screen bg-background text-foreground p-8 md:p-24 relative overflow-hidden transition-colors">
            ...
            <div className="max-w-3xl mx-auto z-10 relative">
                <h1 className="text-4xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-500">
                    About DisposeMail
                </h1>

                <div className="prose prose-lg text-gray-600 dark:text-gray-400 prose-headings:text-gray-900 dark:prose-headings:text-gray-100">
                    <p>
                    ...
                    <h3 className="mt-8 font-bold text-xl text-gray-900 dark:text-gray-200">Our Technology</h3>
                    <p className="mt-4">
                    ...
                    <h3 className="mt-8 font-bold text-xl text-gray-900 dark:text-gray-200">Open Source</h3>
                    <p className="mt-4">
                ...
                <div className="mt-12 pt-8 border-t border-gray-200 dark:border-[#222]">
                    <a href="/" className="text-blue-600 hover:text-blue-500 dark:text-blue-500 dark:hover:text-blue-400 transition-colors">← Create Temporary Email</a>
                </div>
            </div>
        </main>
    );
