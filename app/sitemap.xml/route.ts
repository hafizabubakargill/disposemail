...
const ROUTES = [
    ...
    { path: '/blog/how-temporary-email-protects-phishing', priority: '0.8', freq: 'weekly' },
    { path: '/blog/never-use-work-email-personal', priority: '0.8', freq: 'weekly' },
    { path: '/blog/ultimate-guide-digital-anonymity-2026', priority: '0.8', freq: 'weekly' },
