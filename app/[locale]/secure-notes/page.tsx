...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const t = await getTranslations({ locale: resolvedParams.locale, namespace: 'SecureNotes' });
    
    return {
        title: t('metaTitle') || 'Secure Notes (Burn-After-Reading) | DisposeMail',
        description: t('metaDesc') || 'Create end-to-end encrypted notes that automatically self-destruct from the server the instant they are read.',
    };
}
            ...
            <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center">
                ...
                <div className="text-center mb-12 max-w-3xl">
                    ...
                    <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 text-gray-900 dark:text-white">
                        Secure <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-cyan-500 dark:from-indigo-400 dark:to-cyan-400">Notes</span>
                    </h1>
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl w-full">
                    <div className="p-8 rounded-2xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 shadow-xl dark:shadow-none backdrop-blur-sm transition-colors">
                        <div className="w-12 h-12 bg-rose-100 dark:bg-rose-500/20 rounded-xl flex items-center justify-center mb-6">
                            <span className="text-rose-600 dark:text-rose-400 font-bold text-xl">1</span>
                        </div>
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Burn After Reading</h3>
                    ...
                    <div className="p-8 rounded-2xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 shadow-xl dark:shadow-none backdrop-blur-sm transition-colors">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Mathematical Privacy</h3>
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
