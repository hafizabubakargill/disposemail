...
export function Footer() {
    ...
    return (
        <footer className="w-full bg-slate-900 text-slate-200 dark:bg-[#07090e] dark:text-slate-300 border-t border-slate-800 dark:border-[#181d29] pt-14 pb-8 px-6 mt-auto">
                ...
                <div className="pt-8 border-t border-slate-800 dark:border-[#181d29] flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-medium text-slate-400">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <a 
                            ...
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="hover:text-blue-400 transition-colors flex items-center gap-1.5 text-xs font-bold"
                        ...
                        <a 
                            ...
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="hover:text-pink-400 transition-colors flex items-center gap-1.5 text-xs font-bold"
                        ...
                        <a 
                            ...
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="hover:text-sky-400 transition-colors flex items-center gap-1.5 text-xs font-bold"
