        ...
        <nav className="w-full flex justify-between items-center px-6 md:px-8 py-6 z-50 max-w-7xl mx-auto relative">
                            ...
                            >
                                ...
                                <div className="bg-white dark:bg-[#111] border border-gray-200 dark:border-[#222] rounded-2xl shadow-2xl shadow-black/10 dark:shadow-black/50 overflow-hidden">
                                    ...
                                    <div className="flex items-center justify-between px-5 py-3 border-b border-gray-100 dark:border-[#1a1a1a]">
                                        ...
                                        <Link href="/free-tools" onClick={() => setToolsOpen(false)} className="text-[10px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest hover:underline flex items-center gap-1">
            ...
            {menuOpen && (
                <div className="absolute top-20 left-0 right-0 max-h-[80vh] overflow-y-auto bg-white dark:bg-[#111] border-y border-gray-200 dark:border-[#222] p-6 flex flex-col gap-4 z-50 md:hidden animate-in fade-in slide-in-from-top-4 duration-200 shadow-xl">
                    <Link href="/" className="text-lg font-medium text-gray-900 dark:text-gray-100 py-1" onClick={() => setMenuOpen(false)}>{t('home')}</Link>
                    <Link href="/about" className="text-lg font-medium text-gray-900 dark:text-gray-100 py-1" onClick={() => setMenuOpen(false)}>{t('about', { fallback: 'About Us' })}</Link>
                    <Link href="/blog" className="text-lg font-medium text-gray-900 dark:text-gray-100 py-1" onClick={() => setMenuOpen(false)}>{t('blog')}</Link>
                    ...
                    <div className="border-t border-gray-100 dark:border-[#1a1a1a] pt-4">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <Link href="/free-tools" onClick={() => setMenuOpen(false)} className="text-[10px] font-black text-blue-600 dark:text-blue-400 uppercase bg-blue-50 dark:bg-blue-900/20 px-2 py-1 rounded-md">View all →</Link>
                        </div>
                    ...
                    <Link href="/faq" className="text-lg font-medium text-gray-900 dark:text-gray-100 py-2 border-t border-gray-100 dark:border-[#1a1a1a] mt-2" onClick={() => setMenuOpen(false)}>{t('faq')}</Link>
